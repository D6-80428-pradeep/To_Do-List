document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadTasks() {
        ...
        const tasks = JSON.parse(localStorage.getItem(`tasks-${formattedDate}`)) || [];
    ...
    function addTask(event) {
        ...
        const tasks = JSON.parse(localStorage.getItem(`tasks-${formatDate(currentDate)}`)) || [];
    ...
    function searchTasks() {
        ...
        const tasks = Array.from(taskTableBody.children);
        tasks.forEach(task => {
